              ...
              {Array.from(Array(columns).keys()).map((column, index) => {
                ...
                return (
                  seat * columns + column + 1 <= totalSeats && (
                    ...
                    >
                      <p className="text-sm">{seat * columns + column + 1}</p>
                    </div>
                  )
                );
              })}
    ...
    show && (
      <div>
        ...
        {selectedSeats.length > 0 && (
          <div className="mt-2 flex justify-center gap-1 items-center flex-col">
            <div className="flex justify-center">
              <div className="flex card p-2 gap-3">
            ...
            <StripeCheckout
              ...
              stripeKey="pk_test_51Mo06ISFFSQe2cFezorWFXgv1w89RTjFQd2V7NTslpuLN5neFXTF4iXuC6b3h8JUfViEFsMGiOWw7eo2xI9HLtoe00Z8diy0do"
            >
